        ...
        <div className="body">
            ...
            >
                ...
                <div className='flex flex-col gap-[.4rem]'>
                    <label className='text-xl text-[#8A8A8A]' htmlFor="userPassword">Enter your password</label>
                    ...
                    <span className='self-end text-[15px] text-[#6CBC37] font-semibold cursor-pointer'>Forgot your password?</span>
                </div>
                <div className='flex flex-col text-center gap-[2.2rem]'>
                    <button className='bg-[#6CBC37] px-4 py-4 border-2 border-transparent hover:border-[#6CBC37] hover:bg-transparent hover:text-[#6CBC37] duration-500 text-white text-xl'>Sign in</button>
                    <span className='text-[15px] text-[#2C2C2C] font-semibold'>Don't have an account? <span className='text-[#6CBC37] cursor-pointer'>Sign Up</span></span>
                </div>
            </form>
        </div>
      </div>
